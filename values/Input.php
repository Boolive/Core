...
/**
 * @property \boolive\core\values\Values path Элементы пути URI
 * @property \boolive\core\values\Values REQUEST = GET+POST+argv данные или аргументы командной строки
 * @property \boolive\core\values\Values FILES Загруженные файлы
 * @property \boolive\core\values\Values COOKIE Куки
