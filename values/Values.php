...
class Values implements IteratorAggregate, ArrayAccess, Countable, ITrace
{
    ...
    private $_value;
    /** @var \boolive\core\values\Rule Правило по умолчанию для значения */
    protected $_rule;
    /** @var bool Признак, отфильтрованы значения (true) или нет (false)? */
    protected $_filtered;
    /** @var array Объекты \boolive\core\values\Values для возвращения элементов при обращении к ним, если $this->_value массив*/
    protected $_interfaces;
    /** @var \boolive\core\values\Values Родитель объекта для оповещения об изменениях значения */
    protected $_maker;
     ...
     * @param null|\boolive\core\values\Rule $rule Правило проверки значений по умолчанию
     */
    ...
    /**
     * Проверка значения
     * @param \boolive\core\values\Rule $rule Правило проверки
     * @param \boolive\core\errors\Error | null $error Ошибки после проверки
     * @return bool
     */
     ...
     * @param null|\boolive\core\values\Rule $rule
     * @return \boolive\core\values\Values
     */
...
//        foreach ($this->_interfaces as $i) $i->_maker = null;
     ...
     * @return array|\boolive\core\values\Values
     */
    function __get($name)
    {
